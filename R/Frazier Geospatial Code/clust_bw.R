...
densityCluster <- function(x, cutoff=5, bw=0.005, plot1="fig1.png", plot2="fig2.png") {
...
# obtain clusters
res <- densityCluster(lga_mask_05_matrix, cutoff=5, bw=.005, plot1="fig1.png", plot2="fig2.png")
